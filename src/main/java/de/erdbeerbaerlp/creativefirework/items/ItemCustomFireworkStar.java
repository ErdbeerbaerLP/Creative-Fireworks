...
public class ItemCustomFireworkStar extends ItemFireworkStar {

	public ItemCustomFireworkStar(Properties builder) {
		super(builder);
		// TODO Auto-generated constructor stub
	}
	@OnlyIn(Dist.CLIENT)
	public static void func_195967_a(NBTTagCompound p_195967_0_, List<ITextComponent> p_195967_1_) {
		ItemCustomRocket.Shape itemfireworkrocket$shape = ItemCustomRocket.Shape.getShape(p_195967_0_.getByte("Type"));
		p_195967_1_.add((new TextComponentTranslation("item.minecraft.firework_star.shape." + itemfireworkrocket$shape.getName())).applyTextStyle(TextFormatting.GRAY));
