package de.erdbeerbaerlp.creativefirework.particles;
...
public class ParticleCustomFirework extends ParticleFirework.Starter{
	private int fireworkAge;
	private final ParticleManager manager;
	private NBTTagList fireworkExplosions;
	private boolean twinkle;

	public ParticleCustomFirework(World p_i46464_1_, double p_i46464_2_, double p_i46464_4_, double p_i46464_6_, double p_i46464_8_, double p_i46464_10_, double p_i46464_12_, ParticleManager p_i46464_14_, @Nullable NBTTagCompound p_i46464_15_) {
		super(p_i46464_1_, p_i46464_2_, p_i46464_4_, p_i46464_6_, p_i46464_8_, p_i46464_10_, p_i46464_12_, p_i46464_14_, p_i46464_15_);
	...
	public void tick() {
		...
		if (this.fireworkAge % 2 == 0 && this.fireworkExplosions != null && this.fireworkAge / 2 < this.fireworkExplosions.size()) {
			...
			try {
				ParticleFirework.Overlay particlefirework$overlay = ParticleFirework.Overlay.class.getConstructor(World.class, double.class, double.class,double.class).newInstance(this.world, this.posX, this.posY, this.posZ);
