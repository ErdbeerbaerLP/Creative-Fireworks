package de.erdbeerbaerlp.creativefirework.entity;

import de.erdbeerbaerlp.creativefirework.MainClass;
import de.erdbeerbaerlp.creativefirework.particles.ParticleCustomFirework;
...
public class EntityCustomRocket extends Entity {

	 private static final DataParameter<ItemStack> FIREWORK_ITEM = EntityDataManager.createKey(EntityCustomRocket.class, DataSerializers.ITEM_STACK);
	   private static final DataParameter<Integer> BOOSTED_ENTITY_ID = EntityDataManager.createKey(EntityCustomRocket.class, DataSerializers.VARINT);
	   ...
	   public EntityCustomRocket(World worldIn) {
	      super(MainClass.CUSTOM_ROCKET_TYPE, worldIn);
	   ...
	   public EntityCustomRocket(World worldIn, double x, double y, double z, ItemStack givenItem) {
	      super(MainClass.CUSTOM_ROCKET_TYPE, worldIn);
	      this.fireworkAge = 0;
	      this.setSize(0.25F, 0.25F);
	   ...
	   public EntityCustomRocket(World p_i47367_1_, ItemStack p_i47367_2_, EntityLivingBase p_i47367_3_) {
...
//	         double d0 = 5.0D;
	...
	public void handleStatusUpdate(byte id) {
		if (id == 17 && this.world.isRemote) {
	         ItemStack itemstack = this.dataManager.get(FIREWORK_ITEM);
	         NBTTagCompound nbttagcompound = itemstack.isEmpty() ? null : itemstack.getChildTag("Fireworks");
	         MainClass.LOGGER.info("CUSTOM");
	         Minecraft.getInstance().particles.addEffect(new ParticleCustomFirework(Minecraft.getInstance().world, this.posX, this.posY, this.posZ, this.motionX, this.motionY, this.motionZ,Minecraft.getInstance().particles, nbttagcompound));
